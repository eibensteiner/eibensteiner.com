<template>
    <header class="p-5 border-b border-gray-100">
        ...
        <div class="flex mt-6">
            ...
            <ButtonCopyToClipboard :type="'secondary'" :label="'Share Profile'" :clipboard-text="email"></ButtonCopyToClipboard>
        </div>
    </header>
</template>

<script setup>
const props = defineProps(['name', 'description', 'email', 'avatar'])
</script>